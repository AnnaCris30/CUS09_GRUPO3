...
class Recaudacion(db.Model):
    ...
    n_operacion = db.Column(db.numeric)
    ...
    id_recaudacion_estado = db.Column(db.Integer(150), db.ForeignKey('recaudacion_estado.id_recaudacion_estado'))
    id_cuenta_predio = db.column(db.Integer, db.ForeignKey('cuenta_predio.id_cuenta_predio'))
    observacion = db.Column(db.character(100))
